...
public class MGPrefsCacheManager {

    private static MGPrefsCacheManager instance;
    private SharedPreferences mSharedPreferences;

    private MGPrefsCacheManager() {
    }

    public static MGPrefsCacheManager getInstance() {
        if (instance == null) {
            instance = new MGPrefsCacheManager();
        }
